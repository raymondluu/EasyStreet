...
public interface Movable {
  ...
  /**
   * Returns whether or not this object may move onto the given type of terrain,
   ...
   */
  Direction chooseDirection(Map<Direction, Terrain> the_neighbors, Light the_light);
  ...
  /**
   * Returns whether this Movable object is alive and should move on the map.
   * 
  ...
  /**
   * Called by the UI to notify a dead vehicle that 1 movement round has passed,
   * so that it will become 1 move closer to revival.
   */
  void poke();
